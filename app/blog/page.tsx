...
export default async function BlogIndex() {
  ...
  return (
    <main className="bg-white text-ink">
      {/* ── HERO ── (content width matches the homepage: max-w-[1200px]) */}
      <section className="mx-auto w-full max-w-[1200px] px-4 pb-12 pt-[140px] sm:px-6 lg:px-8">
      ...
      {/* ── POSTS ── */}
      <section className="mx-auto max-w-[1200px] px-4 pb-16 pt-2 sm:px-6 lg:px-8">
        {posts.length === 0 ? (
