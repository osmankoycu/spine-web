...
// Merged closing section for Template B — the page's CTA (heading + lead +
...
// Takes only the CTA slice (not the whole page) so unused page data — e.g. the
// removed testimonial — isn't serialized into the client payload.
