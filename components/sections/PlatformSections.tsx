...
export function PlatformSections() {
  return (
    <section className="bg-bg px-4 py-11 sm:px-6 lg:px-8 lg:py-14">
      <div className="relative z-10 mx-auto max-w-[1200px] overflow-hidden rounded-[32px] border border-[#ededea] bg-white shadow-[0_1px_0_rgba(0,0,0,0.02),0_40px_80px_-52px_rgba(20,20,18,0.2)]">
        <Benefits />
